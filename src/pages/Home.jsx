...
export const Home = () => {
  return (
    <>
      <div className="relative flex items-center justify-center bg-[url('images/tontura-titulo.GIF')] bg-contain lg:bg-cover bg w-screen h-screen lg:w-full lg:h-[800px]">
